...
## Recent Changes
- **v7.31.2 (2026-02-10)**: Post-Refactor Code Cleanup — removed 6 orphaned component files (~1,526 lines dead code), consolidated duplicate PlayerSlot type to single source of truth, removed 9 unused imports across 5 files, cleaned up unused exports from shared utilities. Restored TrackmanNotesModal that was accidentally disconnected during v7.31.0 refactoring.
