        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 640px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; padding: 40px;">
          ...
          <tr>
            <td style="padding: 24px; background-color: #f9fafb; border-radius: 12px;">
              ...
              <p style="margin: 0 0 12px; font-size: 13px; color: #374151; line-height: 1.6;">Members may bring guests to the Club subject to the guest policy applicable to their membership tier. Each membership tier includes a specified number of complimentary guest passes per month. Additional guest visits beyond the included passes will incur a guest fee, which will be charged to the member's payment method on file. Members are responsible for the conduct of their guests at all times. Guests must comply with all Club rules and policies. The Club reserves the right to refuse entry to any guest and to modify the guest policy or fees with reasonable notice.</p>
