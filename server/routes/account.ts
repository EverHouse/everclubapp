    ...
    try {
      ...
      await client.emails.send({
        ...
        html: `
          ...
          <p>We've received your request to delete your Ever House account.</p>
          ...
          <p>If you did not make this request or have changed your mind, please contact us immediately at <a href="mailto:info@evenhouse.club">info@evenhouse.club</a>.</p>
          <p>Thank you for being a part of the Ever House community.</p>
          <p>Best regards,<br>The Ever House Team</p>
        `
      });
    } catch (emailError) {
