...
export const TRAINING_SEED_DATA = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Advanced Filters', content: 'For Active members, filter by: Tier (All, Social, Core, Premium, Corporate, VIP), Status (active, trialing, past_due, grace_period, paused, pending), App Usage (Logged In, Never Logged In), Billing type (Individual, Group, Stripe, MindBody, Family Add-on, Comped), and Discount code.', pageIcon: 'filter_list' },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Contact & Social Media', content: 'Set the club phone number, contact email, and physical address. Add social media links for Instagram, TikTok, and LinkedIn. Configure Apple Messages for Business with a toggle and Business ID.', pageIcon: 'business' },
