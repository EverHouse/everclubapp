...
export const TRAINING_SEED_DATA = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Manual Booking', content: 'Create a manual booking for walk-ins or phone reservations. Select the member, choose a bay, pick the date and time, set the duration and player count, and optionally add a booking source.', pageIcon: 'edit_calendar' },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Booking Sheet', content: 'Tapping any booking card opens the Booking Sheet — a detailed view where you can manage the roster, view fees, process payments, reschedule, cancel, or check in the booking. All booking actions happen from within this sheet.' },
      ...
      { title: 'Manual Booking', content: 'The floating action button (+) lets you create a manual booking for walk-ins or phone reservations. You can also tap an empty cell on the Calendar Grid to pre-fill the bay and time.' },
