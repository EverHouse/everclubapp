...
export const TRAINING_SEED_DATA = [
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Adding Members', content: 'Tap a "Guest (info pending)" placeholder slot to search for club members by name or email. When you select a member, they replace the placeholder and are immediately added to the booking roster.' },
      { title: 'Adding Guests', content: 'To add a non-member guest, use the guest option on a placeholder slot. Enter the guest\'s name and optionally their email. Fees are recalculated automatically after adding a guest.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: 'Placeholder Slot Protection', content: 'Guest passes cannot be consumed for placeholder slots labeled "Guest (info pending)". A real guest name must be assigned before a pass can be applied. This prevents accidental waste of passes on unfilled slots.', pageIcon: 'shield' },
