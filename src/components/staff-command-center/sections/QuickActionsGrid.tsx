  ...
  if (variant === 'desktop') {
    return (
      <div className="flex-1 h-full bg-white/40 dark:bg-white/[0.08] backdrop-blur-xl border border-white/60 dark:border-white/[0.12] rounded-xl p-4 shadow-liquid dark:shadow-liquid-dark flex flex-col">
        <h3 className="text-2xl leading-tight font-bold text-primary dark:text-white mb-4" style={{ fontFamily: 'var(--font-headline)' }}>Employee Resources</h3>
        
        <div className="flex-1 flex flex-col justify-between">
          <div>
            <p className="text-[11px] font-semibold text-primary/80 dark:text-white/80 uppercase tracking-[0.2em] mb-2" style={{ fontFamily: 'var(--font-label)' }}>Quick Links</p>
          ...
          {isAdmin && (
            <div className="pt-4 border-t border-primary/10 dark:border-white/10">
              <p className="text-[11px] font-semibold text-primary/80 dark:text-white/80 uppercase tracking-[0.2em] mb-2" style={{ fontFamily: 'var(--font-label)' }}>Admin Settings</p>
              <div className="grid grid-cols-2 gap-2">
