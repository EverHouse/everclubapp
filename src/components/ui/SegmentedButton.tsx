              ...
              >
                {isSelected && (
                  <motion.div
                    ...
                    className="absolute inset-0 rounded-xl bg-primary/10 dark:bg-white/15"
                ...
                {isSelected && showCheckmark && (
                  <motion.span
                    ...
                    transition={prefersReduced ? { duration: 0 } : { type: 'spring', stiffness: 500, damping: 30, duration: 0.15 }}
                  >
                    <svg
                      width="18"
                      height="18"
