  ...
  const menuContent = (
    ...
    >
      ...
      >
        ...
        <div className={`relative z-10 flex flex-col lg:w-[320px] py-8 px-8 safe-area-inset-menu pb-[calc(2rem+env(safe-area-inset-bottom,0px))] h-full ${isDark ? 'text-[#F2F2EC]' : 'text-[#293515]'}`}>
