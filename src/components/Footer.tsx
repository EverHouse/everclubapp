...
export const Footer: React.FC<FooterProps> = ({ hideCta = false }) => (
  <footer className="footer-safe-area-extend bg-[#293515] text-[#E7E7DC] py-16 px-6 text-center rounded-t-[2.5rem] mt-8 -mx-4 sm:-mx-6 w-[calc(100%+2rem)] sm:w-[calc(100%+3rem)]">
