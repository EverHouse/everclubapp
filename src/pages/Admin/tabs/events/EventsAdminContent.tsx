            ...
            <div className="flex gap-2 overflow-x-auto pb-4 mb-4 scrollbar-hide -mx-4 px-4 scroll-fade-right">
                {CATEGORY_TABS.map(tab => (
                    <button
                        ...
                        className={`tactile-btn flex items-center gap-1.5 px-3 py-2 rounded-[4px] text-[10px] sm:text-xs font-bold uppercase tracking-wide whitespace-nowrap transition-colors duration-fast flex-shrink-0 ${
            ...
            >
                <div className="p-5 space-y-4">
                    ...
                    <div>
                        ...
                        <input aria-label="Max attendees" type="number" className="w-full border border-gray-200 dark:border-white/25 bg-gray-50 dark:bg-black/20 p-3 rounded-lg text-primary dark:text-white placeholder:text-gray-500 dark:placeholder:text-white/60" placeholder="e.g., 50" value={newItem.max_attendees || ''} onChange={e => setNewItem({...newItem, max_attendees: parseInt(e.target.value, 10) || null})} />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className={`flex-1 py-2.5 px-4 rounded-lg font-bold text-sm transition-colors duration-fast flex items-center justify-center gap-2 ${
