        ...
        <div className="animate-page-enter">
            ...
            <div className="flex gap-2 overflow-x-auto pb-4 mb-4 scrollbar-hide -mx-4 px-4 animate-content-enter-delay-3 scroll-fade-right">
                {FORM_TYPE_CHIPS.map(chip => (
                    <button
                        ...
                        className={`flex-shrink-0 px-3 py-2 min-h-[44px] rounded-[4px] text-xs font-semibold transition-colors duration-fast ${
            ...
            {isLoading ? (
                ...
                <div className="bg-white dark:bg-surface-dark rounded-xl p-8 flex flex-col items-center text-center shadow-sm border border-gray-200 dark:border-white/20">
                    <Icon name="mail" className="text-5xl text-gray-500 dark:text-gray-500 mb-3" />
