                                ...
                                <button
                                    onClick={() => {
                                        if ('caches' in window) {
                                            ...
                                            }).catch((err: unknown) => { console.warn('[AvailabilityBlocks] Failed to clear caches:', err); });
                                        }
                ...
                <div className="space-y-3">
                    {groupedUpcoming.slice(0, visibleDayCount).map(({ date, blocks: dayBlocks }, groupIndex) => {
                        ...
                        return (
                            <div 
                                key={date} 
                                className="bg-white dark:bg-surface-dark rounded-xl border border-gray-200 dark:border-white/20 overflow-hidden"
                            >
                                <button
                                    ...
                                    <div className="border-t border-gray-100 dark:border-white/10 p-3 space-y-3">
                                        {dayBlocks.map((block, blockIndex) => (
                                            <div 
                                                ...
                                                className="tactile-row bg-gray-50 dark:bg-black/20 p-3 rounded-lg flex flex-col gap-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-black/30 transition-colors"
                                            >
