...
export const StaffNavigationRail: React.FC<StaffNavigationRailProps> = ({
  ...
  const railContent = (
    <aside
      className="hidden md:flex lg:hidden flex-col w-20 h-screen fixed left-0 top-0 bg-gradient-to-b from-[#293515] via-[#1f2a0f] to-[#1a220c] border-r border-white/10 isolate"
      style={{ zIndex: 9999 }}
    >
