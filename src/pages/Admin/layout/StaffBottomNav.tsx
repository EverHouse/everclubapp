          ...
          >
            <span className="relative inline-flex">
              ...
              {item.id === 'simulator' && pendingRequestsCount > 0 && (
                <span className="absolute -top-1.5 -right-3 min-w-[16px] h-4 px-1 flex items-center justify-center bg-red-500 text-white text-[10px] font-bold rounded-full shadow-sm animate-badge-pulse">
