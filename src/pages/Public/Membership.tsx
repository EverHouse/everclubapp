...
const MembershipOverview: React.FC = () => {
  ...
  return (
    ...
    <div className="px-4 pt-4 pb-0 flex flex-col gap-8 bg-[#F2F2EC] min-h-screen overflow-x-hidden">
      ...
      {/* Sticky Mobile CTA - Green bar with bone safe area filler for Safari toolbar */}
      <div 
        className="fixed bottom-0 left-0 right-0 md:hidden"
        style={{ zIndex: 50 }}
      >
        {/* Green content area */}
        <div className="bg-[#293515] px-4 pt-3 pb-4 border-t border-white/10">
          <button 
            onClick={() => setShowApplicationForm(true)}
        ...
        {/* Bone safe area filler for Safari translucent toolbar */}
        <div 
          className="bg-[#F2F2EC]" 
