         ...
         <Section title="Connected Accounts" isDark={isDark} staggerIndex={3.5}>
           ...
           <div className={`px-4 pb-3 ${isDark ? 'opacity-50' : 'text-primary/40'}`}>
             <div className="flex items-center gap-3">
               <svg className="w-5 h-5" viewBox="0 0 24 24">
                 <path fill="currentColor" d="M17.05 20.28c-1.53.94-3.27 1.47-5.05 1.47-5.52 0-10-4.48-10-10S6.48 1.75 12 1.75c2.83 0 5.39 1.18 7.22 3.07l-2.95 2.95C15.24 6.69 13.72 6.12 12 6.12c-3.19 0-5.78 2.59-5.78 5.78s2.59 5.78 5.78 5.78c2.52 0 4.66-1.62 5.44-3.87H12v-3.5h9.72c.14.86.22 1.75.22 2.65 0 2.93-1.07 5.48-2.89 7.32z"/>
               </svg>
               <div>
