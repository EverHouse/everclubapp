        ...
        <>
          ...
          <div className="py-3 px-6">
            <button
              ...
              className={`flex items-center gap-2 text-sm font-medium transition-colors duration-fast ${
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <button
                onClick={handlePasskeyRegister}
                disabled={passkeyRegistering}
                className={`mt-3 px-4 py-2 rounded-lg text-xs font-bold transition-colors duration-fast ${
