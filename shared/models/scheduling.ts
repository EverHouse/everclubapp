...
export const participantPaymentStatusEnum = pgEnum("participant_payment_status", ["pending", "paid", "waived", "refunded", "refund_pending"]);
...
// Tours table - scheduled tours synced from HubSpot Meetings
